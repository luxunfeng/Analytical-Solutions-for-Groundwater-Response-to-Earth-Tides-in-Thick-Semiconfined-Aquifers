...
%     tanxx = @(ep)  ep*tan(ep*hd)-lambda_d ;
    ...
    xlabel('$\omega_D:$ Dimensionless frequencies of tidal constituents','FontSize',14,'Interpreter', 'latex', 'FontWeight', 'bold')
...
% legend("$h_D\sqrt{H_D}="+sprintf('%0.3f',criterion(1))+"-Lu\ et\ al.,\ 2022$", ...
%     "$h_D\sqrt{H_D}="+sprintf('%0.3f',criterion(1))+"-new\ model$", ...
%         "$h_D\sqrt{H_D}="+sprintf('%0.3f',criterion(2))+"-Lu\ et\ al.,\ 2022$", ...
%         "$h_D\sqrt{H_D}="+sprintf('%0.3f',criterion(2))+"-new\ model$", ...
%          "$h_D\sqrt{H_D}="+sprintf('%0.3f',criterion(3))+"-Lu\ et\ al.,\ 2022$", ...
%          "$h_D\sqrt{H_D}="+sprintf('%0.3f',criterion(3))+"-new\ model$", ...
%         'Interpreter', 'latex', 'FontWeight', 'bold','box','off', 'Location', 'eastoutside')
xlim([1e-3,1e+1])
subplot(2,2,3)
